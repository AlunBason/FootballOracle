...
using FootballOracle.Models.ViewModels.Account;
using Microsoft.AspNet.Identity;
using Microsoft.AspNet.Identity.Owin;
using Microsoft.Owin.Security;

namespace FootballOracle.Website.Areas.Acc.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Confirm your account", "Please confirm your account by clicking this link or copying and pasting it into a browser: \r\n" + callbackUrl);
        ...
        {
            foreach (var error in result.Errors.Where(e => e.Substring(0,4) != "Name"))
            {
