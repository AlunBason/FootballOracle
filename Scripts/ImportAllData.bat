...
@echo InitialData.sql
%mysqlpath% -h%svr% -u%usr% -p%pwd% --silent < %scriptpath%\Initial\InitialData.sql
rem @echo EnglandTeamData.sql
rem %mysqlpath% -h%svr% -u%usr% -p%pwd% --silent < %scriptpath%\Team\EnglandTeamData.sql
rem @echo WalesTeamData.sql
rem %mysqlpath% -h%svr% -u%usr% -p%pwd% --silent < %scriptpath%\Team\WalesTeamData.sql
